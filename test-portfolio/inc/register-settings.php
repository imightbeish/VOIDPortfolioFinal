...
function portfolio_project_customizer($wp_customize) {
  require 'section_vars.php';
  $wp_customize->add_section('project-section', array(
    'title' => 'Projects',
  ));
  $wp_customize->add_setting('project-title', array(
    'default' => 'Default Project Name'
  ));
  $wp_customize->add_control('project-title', array(
    'label' => 'Project Name',
    'section' => 'project_section',
  ));
  $wp_customize->add_setting('project-description');
  $wp_customize->add_control('project-description', array(
...
add_action('customize_register', 'portfolio_project_customizer');
